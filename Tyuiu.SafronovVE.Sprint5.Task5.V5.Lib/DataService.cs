...
namespace Tyuiu.SafronovVE.Sprint5.Task5.V5.Lib
{
    public class DataService : ISprint5Task5V5
    {
        ...
        {
            File.WriteAllText(@"/app/data/AssesmentData/C#/Sprint5Task5/InPutDataFileTask5V5.txt", "-3.09 3 3 7.48 -3.22 17.29 8 -4 0.83 14.18 -6 8.15 -8.7 -3.06 20 -4 15.82 -10 9 -3");
